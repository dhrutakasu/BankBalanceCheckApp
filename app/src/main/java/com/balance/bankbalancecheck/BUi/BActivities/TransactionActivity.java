        ...
        TxtOkFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (IsStartDate && !IsEndDate) {
                    System.out.println("---- -- - - ISD-!IED : " + IsStartDate + " - " + IsEndDate);
                    ...
                    System.out.println("---- -- - - !ISA-!IEA : " + IsStartAmount + " - " + IsEndAmount);
                    ...
                    System.out.println("---- -- - - ISD-IED & ISA-IEA : " + IsStartDate + " - " + IsEndDate + " - " + IsStartAmount + " - " + IsEndAmount);
