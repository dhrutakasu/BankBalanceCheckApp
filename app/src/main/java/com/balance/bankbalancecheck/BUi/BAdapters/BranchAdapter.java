...
public class BranchAdapter extends RecyclerView.Adapter<BranchAdapter.MyViewHolder> implements Filterable {
    private final Context context;
    private final BankListener listern;
    private ArrayList<String> strings;
    private final ArrayList<String> stringsNew;

    public BranchAdapter(Context context, ArrayList<String> strings, BankListener listener) {
