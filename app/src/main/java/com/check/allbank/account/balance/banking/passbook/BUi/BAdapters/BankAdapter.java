...
public class BankAdapter extends RecyclerView.Adapter<BankAdapter.MyViewHolder> implements Filterable {
    private final Context context;
    private final BankListener listern;
    private ArrayList<String> strings;
    private final ArrayList<String> stringsNew;

    public BankAdapter(Context context, ArrayList<String> strings, BankListener listener) {
