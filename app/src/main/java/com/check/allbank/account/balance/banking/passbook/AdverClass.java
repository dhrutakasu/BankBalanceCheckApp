...
public class AdverClass {
        ...
        if (IsInternetOn(con)) {
            ...
            BankConstantsData.LoadAdsData(con, new BankConstantsData.LoadAdsId() {
                ...
                public void getAdsIds(AdverModel adverModel) {
                    ...
                    if (adverModel.getBannerType().equalsIgnoreCase("1")) {
                        if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                            ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.GONE);
                        }
                        showGAdMobBanner(con, com.google.android.gms.ads.AdSize.BANNER, layout, adverModel.getBannerAd(), adverModel.getAdslogin(), adverModel.getFbad());
                    } else {
                        if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                            ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.VISIBLE);
                        }
                        Initialize(con);
                        showFbookBanner(con, com.facebook.ads.AdSize.BANNER_HEIGHT_50, layout, adverModel.getFbad(), adverModel.getAdslogin(), adverModel.getBannerAd());
                    }
                }
            });
        } else {
    ...
    public static void showFbookBanner90(Context con, com.facebook.ads.AdSize adSize, RelativeLayout layout, String Fbid, String shows, String bAd) {
        if (!Fbid.equalsIgnoreCase("")) {
            com.facebook.ads.AdView adView = new com.facebook.ads.AdView(con, Fbid, adSize);
            layout.addView(adView);
            com.facebook.ads.AdListener adListener = new com.facebook.ads.AdListener() {
                ...
                public void onError(Ad ad, com.facebook.ads.AdError error) {
                    ...
                    showGAdMobBanner90(con, AdSize.LARGE_BANNER, layout, bAd, shows, Fbid);
                }
    ...
    public static void showGAdMobBanner90(Context con, AdSize adSize, RelativeLayout layout, String Gid, String shows, String fbookbad) {
        if (!Gid.equalsIgnoreCase("")) {
            AdView adView = new AdView(con);
            adView.setAdSize(adSize);
            adView.setAdUnitId(Gid);
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdFailedToLoad(LoadAdError loadAdError) {
                    ...
                    Initialize(con);
                    showFbookBanner90(con, com.facebook.ads.AdSize.BANNER_HEIGHT_90, layout, fbookbad, shows, Gid);
                }
    ...
    public static void ShowLayoutBannerAds90(Context con, ProgressBar progressBar, RelativeLayout layout) {
        if (IsInternetOn(con)) {
            progressBar.setVisibility(View.VISIBLE);
            BankConstantsData.LoadAdsData(con, new BankConstantsData.LoadAdsId() {
                @Override
                public void getAdsIds(AdverModel adverModel) {
                    ...
                    if (adverModel.getBannerType().equalsIgnoreCase("1")) {
                        ...
                        showGAdMobBanner90(con, com.google.android.gms.ads.AdSize.LARGE_BANNER, layout, adverModel.getBannerAd(), adverModel.getAdslogin(), adverModel.getFbad());
                    } else {
                        if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                            ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.VISIBLE);
                        }
                        Initialize(con);
                        showFbookBanner90(con, com.facebook.ads.AdSize.BANNER_HEIGHT_90, layout, adverModel.getFbad(), adverModel.getAdslogin(), adverModel.getBannerAd());
                    }
                }
            });
        } else {
    ...
    public static void ShowLayoutInterstitialAd(Context con, setAdListerner adListerner) {
        ...
        if (IsInternetOn(con)) {
            BankConstantsData.LoadAdsData(con, new BankConstantsData.LoadAdsId() {
                @Override
                public void getAdsIds(AdverModel model) {
                    if (c % Integer.parseInt(model.getAdscount()) == 0) {
                        if (model.getItype().equalsIgnoreCase("1")) {
                            if (!model.getInad().equalsIgnoreCase("")) {
                                if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                                    ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.GONE);
                                }
                                ShowGAdMobInterstitialAd((Activity) con, model.getInad(), model.getAdslogin(), model.getFbIad(), adListerner);
                            } else {
                                if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                                    ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.VISIBLE);
                                }
                                Initialize(con);
                                ShowFbookInterstitialAd((Activity) con, model.getFbIad(), model.getInad(), model.getAdslogin(), adListerner);
                            }
                        } else {
                            if (!model.getFbIad().equalsIgnoreCase("")) {
                                if (((Activity) con).findViewById(R.id.NativeBAdContainer) != null) {
                                    ((Activity) con).findViewById(R.id.NativeBAdContainer).setVisibility(View.VISIBLE);
                                }
                                Initialize(con);
        ...
        if (IsInternetOn(con)) {
            ...
            BankConstantsData.LoadAdsData(con, new BankConstantsData.LoadAdsId() {
                ...
                public void getAdsIds(AdverModel adverModel) {
                    ...
                    if (adverModel.getBannerType().equalsIgnoreCase("1")) {
                        if (!adverModel.getNad().equalsIgnoreCase("")) {
                            showGAdMobNativeBanner((Activity) con, adverModel.getNad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getFnad());
                        } else {
                            Initialize(con);
                            showFbookNativeBanner((Activity) con, ((NativeAdLayout) ((Activity) con).findViewById(R.id.NativeBAdContainer)), adverModel.getFnbad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getNad());
                        }
                    } else {
                        if (!adverModel.getFnbad().equalsIgnoreCase("")) {
                            Initialize(con);
                            showFbookNativeBanner((Activity) con, ((NativeAdLayout) ((Activity) con).findViewById(R.id.NativeBAdContainer)), adverModel.getFnbad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getNad());
                        } else {
                            showGAdMobNativeBanner((Activity) con, adverModel.getNad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getFnad());
        ...
        if (IsInternetOn(con)) {
            ...
            BankConstantsData.LoadAdsData(con, new BankConstantsData.LoadAdsId() {
                ...
                public void getAdsIds(AdverModel adverModel) {
                    ...
                    if (adverModel.getBannerType().equalsIgnoreCase("1")) {
                        if (!adverModel.getNad().equalsIgnoreCase("")) {
                            showGAdMobNative((Activity) con, adverModel.getNad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getFnad());
                        } else {
                            Initialize(con);
                            showFbookNative((Activity) con, ((NativeAdLayout) ((Activity) con).findViewById(R.id.NativeBAdContainer)), adverModel.getFnad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getNad());
                        }
                    } else {
                        if (adverModel.getFnad().equalsIgnoreCase("")) {
                            showGAdMobNative((Activity) con, adverModel.getNad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getFnad());
                        } else {
                            Initialize(con);
                            showFbookNative((Activity) con, ((NativeAdLayout) ((Activity) con).findViewById(R.id.NativeBAdContainer)), adverModel.getFnad(), layout, adverModel.getAdslogin(), adverModel.getAppAdsButtonTextColor(), adverModel.getAppAdsButtonColor(), adverModel.getBackgroundcolor(), adverModel.getNad());
